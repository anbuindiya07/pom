...
public class SelectFiles extends ProjectMethod {
...
public static void main(String[] args) throws InterruptedException
	...
	driver.findElementByXPath("//p[contains(text(),'Service Console')]").click();
		...
		public SelectFiles clickLatestItem()
		{
		...
		public SelectFiles PublicLink()
		{
			@SuppressWarnings("deprecation")
			WebDriverWait wait = new WebDriverWait(driver, 30);
			WebElement dropdown = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(@class,'slds-button slds-button--icon-x-small slds-button--icon-border-filled')]"))); 
		...
		public SelectFiles DownloadFile()
		{
			@SuppressWarnings("deprecation")
			WebDriverWait wait = new WebDriverWait(driver, 30);
			WebElement dropdown = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[contains(@class,'slds-button slds-button--icon-x-small slds-button--icon-border-filled')]"))); 
